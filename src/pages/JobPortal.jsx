  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-warm-cream text-charcoal">
        ...
        <section
          ref={searchBarRef}
          className={`sticky top-16 sm:top-20 z-40 bg-warm-cream/95 backdrop-blur-xl border-y border-charcoal/5 px-4 sm:px-6 overflow-x-hidden transition-all duration-300 ${
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div className="flex items-center gap-2 ml-auto sm:ml-0">
                  <Button
                    ...
                    className={`rounded-lg font-bold uppercase tracking-widest text-[10px] sm:text-[11px] p-1.5 sm:p-2 ${
                      viewMode === "grid"
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="flex items-center gap-2 shrink-0 ml-auto">
                  ...
                  <Button
                    ...
                    className={`rounded-lg font-bold uppercase tracking-widest text-[10px] p-2 ${
                      viewMode === "grid"
                        ? "bg-electric-teal hover:bg-deep-teal text-white"
                        : "border-charcoal/20 hover:border-electric-teal hover:text-electric-teal"
                    }`}
